...
8. Optional loader URL: `NEXT_PUBLIC_ADSTERRA_SCRIPT_SRC=YOUR_LOADER_URL`
9. Optional banner script base: `NEXT_PUBLIC_ADSTERRA_BANNER_SCRIPT_BASE=https://www.topcreativeformat.com/`
10. Optional native script base: `NEXT_PUBLIC_ADSTERRA_NATIVE_SCRIPT_BASE=https://plXXXX.effectivegatecpm.com/`
11. Optional base path for rules: `NEXT_PUBLIC_ADS_BASE_PATH=/film`
...
3. In-feed native: between content blocks on the homepage or search results.
